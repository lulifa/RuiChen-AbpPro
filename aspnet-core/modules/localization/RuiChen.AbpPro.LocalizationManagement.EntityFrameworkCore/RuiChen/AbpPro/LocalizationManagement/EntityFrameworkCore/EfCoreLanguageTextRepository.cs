...
{
    public class EfCoreLanguageTextRepository : EfCoreRepository<LocalizationDbContext, LanguageText, int>, ILanguageTextRepository
    {
        public EfCoreLanguageTextRepository(IDbContextProvider<LocalizationDbContext> dbContextProvider) : base(dbContextProvider)
        {
        ...
        public async virtual Task<LanguageText> GetByCultureKeyAsync(
            string resourceName,
            string cultureName,
            string key,
            CancellationToken cancellationToken = default
        ...
        public async virtual Task<List<LanguageText>> GetListAsync(
            string resourceName = null,
        ...
        public async virtual Task<List<LanguageTextDifference>> GetDifferencePagedListAsync(
            string cultureName,
            string targetCultureName,
            string resourceName = null,
            bool? onlyNull = null,
            string filter = null,
            string sorting = nameof(LanguageTextDifference.Key),
            int skipCount = 1,
        ...
        protected async virtual Task<IQueryable<LanguageTextDifference>> BuildTextDifferenceQueryAsync(
            string cultureName,
            string targetCultureName,
            string resourceName = null,
            bool? onlyNull = null,
            ...
            string sorting = nameof(LanguageTextDifference.Key))
        {
            ...
            {
                sorting = nameof(LanguageTextDifference.Key);
            }
            ...
            var query = from crtText in textQuery
                        ...
                        where onlyNull.HasValue && onlyNull.Value
                            ? tt.Value == null
                            : 1 == 1
                        select new LanguageTextDifference(
                             crtText.Id,
                             crtText.CultureName,
                             crtText.Key,
                             crtText.Value,
