...
{
    [ExposeServices(typeof(ILocalizationStoreCache), typeof(LocalizationStoreInMemoryCache))]
    public class LocalizationStoreInMemoryCache : ILocalizationStoreCache, ISingletonDependency
    {
        ...
        private readonly AbpProLocalizationManagementOptions _managementOptions;
        ...
        public LocalizationStoreInMemoryCache(
            ...
            IOptions<AbpProLocalizationManagementOptions> managementOptions)
        {
            _clock = clock;
        ...
        {
            var textRepository = context.ServiceProvider.GetRequiredService<ILanguageTextRepository>();
